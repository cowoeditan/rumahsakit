    ...
    <div class="box">
        ...
        <div class="row">
            <div class="col-lg-6 col-lg-offset-3">
                <?php
                $id = @$_GET['id'];
                $sql_pasien = mysqli_query($con, "SELECT * FROM tb_pasien WHERE id_pasien='$id'") or die (mysqli_error());
                    ...
                    <div class="form-group">
                        ...
                        <div>
                            <label class="radio-inline">
                                <input type="radio" name="jk" id="jk" value="L" <?=$data['jenis_kelamin'] == "L" ? "checked" : null ?> required> Laki-laki
                            </label>
                            <label class="radio-inline">
                                <input type="radio" name="jk" value="P" <?=$data['jenis_kelamin'] == "P" ? "checked" : null ?> required> Perempuan
                            </label>
                        </div>
                    </div>
                    <div class="form-group">
